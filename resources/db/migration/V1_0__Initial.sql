...
INSERT INTO ttype (uuid,flags,dmin,name,glyph,descr,comment) values
  ...
  ('21c00000-0101-0000-000d-000000000000', 3, 1000, 'SPRING_REMOTING',
   'awe/cube', '${SERVICE_URL}.${METHOD}', 'Spring remoting - client'),
  ('21c00000-0101-0000-000e-000000000000', 3, 1000, 'SPRING_HTTP',
  ...
  ('21c00000-0101-0000-0016-000000000000', 3, 1000, 'FLEX',
   'awe/cube', '${DEST}: ${MESSAGE_ID} (${CLIENT_ID})', 'FLEX Remote Service'),
  ('21c00000-0101-0000-0017-000000000000', 3, 1000, 'SPRING',
   'awe/cube', '${CLASS}.${METHOD} -> ${RSLT}', 'Spring invocation');

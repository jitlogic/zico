...
INSERT INTO ttype (uuid,flags,dmin,name,glyph,descr,comment) values
  ('21c00000-0101-0000-0001-000000000000', 1, 1000, 'HTTP',
   'awe/globe', '${METHOD:REQ} ${URI} -> ${STATUS}', 'HTTP request handling'),
  ('21c00000-0101-0000-0002-000000000000', 3, 1000, 'HTTP-CLI',
   'awe/globe', '${METHOD} ${URL}', 'HTTP client request'),
  ('21c00000-0101-0000-0003-000000000000', 3, 1000, 'SQL',
   'awe/database', '${SQL}', 'SQL query'),
  ...
  ('21c00000-0101-0000-0005-000000000000', 1, 1000, 'SOAP',
   'awe/cube', '${URI}: ${HDR.IN.soapOperation} -> ${STATUS}', 'SOAP request handling'),
  ('21c00000-0101-0000-0006-000000000000', 3, 1000, 'SOAP-CLI',
   'awe/cube', '${URL}: ${HDR.OUT.soapOperation} -> ${STATUS}', 'SOAP client request'),
  ('21c00000-0101-0000-0007-000000000000', 1, 1000, 'EJB',
   'awe/cube', '${CLASS}.${METHOD}', 'EJB request handling'),
  ('21c00000-0101-0000-0008-000000000000', 3, 1000, 'EJB-CLI',
   'awe/cube', '${CLASS}.${METHOD}', 'EJB client request'),
  ('21c00000-0101-0000-0009-000000000000', 1, 1000, 'REST',
   'awe/cube', '${HTTP_METHOD} ${URI}', 'REST request handling'),
  ('21c00000-0101-0000-000a-000000000000', 3, 1000, 'REST-CLI',
   'awe/cube', '${CLASS}.${METHOD}', 'REST client request'),
  ('21c00000-0101-0000-000b-000000000000', 1, 1000, 'JMS',
   'awe/cube', '${CLASS}.${METHOD}', 'JMS message handling'),
  ('21c00000-0101-0000-000c-000000000000', 1, 1000, 'QUARTZ',
   'awe/clock', '${GROUP} ${NAME}', 'Quartz Schedules'),
  ('21c00000-0101-0000-000d-000000000000', 3, 1000,
   'SPRING-REMOTING', 'awe/cube', '${SERVICE_URL}.${METHOD}', 'Spring remoting - client'),
  ('21c00000-0101-0000-000e-000000000000', 3, 1000, 'SPRING-HTTP',
   'awe/globe', '${METHOD} ${URL}', 'Spring HTTP client request'),
  ('21c00000-0101-0000-000f-000000000000', 1, 1000, 'CAMEL',
   'awe/globe', '${CLASS} ${CONTEXT_NAME}', 'Apache CAMEL flow'),
  ('21c00000-0101-0000-0010-000000000000', 1, 1000, 'CAS',
   'awe/user-secret', '${ACTION}', 'Jasig CAS action'),
  ('21c00000-0101-0000-0011-000000000000', 1, 1000, 'CAS-CLI',
   'awe/user-secret', '${CAS_URI}', 'Jasig CAS client'),
  ('21c00000-0101-0000-0012-000000000000', 1, 1000, 'MULE-CMP',
   'awe/cube', '${APPLICATION} ${FLOW}', 'Mule ESB component'),
  ('21c00000-0101-0000-0013-000000000000', 1, 1000, 'MULE-DISP',
   'awe/cube', '${APPLICATION} ${URI}', 'Mule ESB dispatcher'),
  ('21c00000-0101-0000-0014-000000000000', 1, 1000, 'MULE-FLOW',
   'awe/cube', '${APPLICATION} ${FLOW}', 'Mule ESB flow'),
  ('21c00000-0101-0000-0015-000000000000', 3, 1000, 'CRYSTAL',
   'awe/cube', '${RID}', 'Crystal Reports Remote Request');
